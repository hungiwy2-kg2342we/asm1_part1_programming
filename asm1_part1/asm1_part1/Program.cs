...
class WaterBillCalculator
{
    static void Main(string[] args)
    {
        ...
        {
            Console.WriteLine("Error: This month's water meter reading should be greater than last month's.");
            Console.ReadLine();
            return; // Thoát khỏi chương trình nếu có lỗi
        }
        // Tính lượng tiêu thụ
    ...
    static double CalculateBill(int customerType, int consumption)
    {
        ...
        double totalWithoutVAT = (pricePerM3 + environmentFeePerM3) * consumption; //(lay so gia nuoc tren m3 + phi moi truong) sau do * so tieu thu cua nuoc 
